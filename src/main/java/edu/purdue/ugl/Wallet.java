...
public class Wallet extends ListFragment {
    Button addButton;
    ListView listview;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){
        ...
        addButton = (Button) rootView.findViewById(R.id.newWallet);
        addButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                alert.setTitle("Create a new Wallet");
                ...
                alert.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        list.add(item);
                        params.add(new BasicNameValuePair("name",tvalue));
                        params.add(new BasicNameValuePair("description", dvalue));
                        new JSON_Parser(getActivity(),params, getActivity(),"POST").execute("http://ugl.sige.us/api/wallet/create");
